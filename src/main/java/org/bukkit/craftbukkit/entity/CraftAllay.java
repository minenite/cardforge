...
public class CraftAllay extends CraftCreature implements org.bukkit.entity.Allay {
    ...
    public void setCanDuplicate(boolean canDuplicate) {
        //this.getHandle().setCanDuplicate(canDuplicate); // TODO
    }
    ...
    public void startDancing() {
        //this.getHandle().forceDancing = true; // TODO
        this.getHandle().setDancing(true);
    }

    @Override
    public void stopDancing() {
        //this.getHandle().forceDancing = false; // TODO
    ...
    public org.bukkit.entity.Allay duplicateAllay() {
       // Allay nmsAllay = this.getHandle().duplicateAllay();
        //return (nmsAllay != null) ? (org.bukkit.entity.Allay) ((EntityBridge) (Object) nmsAllay).getBukkitEntity() : null; // TODO
        this.getHandle().duplicateAllay();
        return null;
    }
