...
public abstract class CraftMob extends CraftLivingEntity implements Mob, io.papermc.paper.entity.PaperLeashable { // Paper - Leashable API
    ...
    public boolean shouldDespawnInPeaceful() {
       // return this.getHandle().shouldDespawnInPeaceful(); // TODO
        return false;
    }
    ...
    public void setDespawnInPeacefulOverride(final TriState state) {
      ...
      //  this.getHandle().despawnInPeacefulOverride = state; // TODO
    }

    @Override
    public TriState getDespawnInPeacefulOverride() {
       // return this.getHandle().despawnInPeacefulOverride; // TODO
        return null;
    }
    ...
    public void setTarget(LivingEntity target) {
        //Preconditions.checkState(!this.getHandle().generation, "Cannot set target during world generation"); // TODO
    ...
    public void setAware(boolean aware) {
        //this.getHandle().aware = aware; // TODO
    }

    @Override
    public boolean isAware() {
       // return this.getHandle().aware; // TODO
        return false;
    }
