...
public class CraftItem extends CraftEntity implements Item {
    ...
    public boolean canMobPickup() {
        //return this.getHandle().canMobPickup; // TODO
        return true;
    }

    @Override
    public void setCanMobPickup(boolean canMobPickup) {
        //this.getHandle().canMobPickup = canMobPickup; // TODO
    }
    ...
    public void setHealth(int health) {
        if (health <= 0) {
            ...
            this.getHandle().discard();//org.bukkit.event.entity.EntityRemoveEvent.Cause.PLUGIN); // TODO
        } else {
