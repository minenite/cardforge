...
public class CraftShulkerBullet extends AbstractProjectile implements ShulkerBullet {
    ...
    public org.bukkit.entity.Entity getTarget() {
        // return this.getHandle().getTarget() != null ? this.getHandle().getTarget().getBukkitEntity() : null; // TODO
        return null;
    }
    ...
    public void setTarget(org.bukkit.entity.Entity target) {
        ...
        this.getHandle().setTarget(target == null ? null : ((CraftEntity) target).getHandle());*/ // TODO
    }
