...
public class CraftItemFrame extends CraftHanging implements ItemFrame {
    ...
    public boolean setFacingDirection(BlockFace face, boolean force) {
        ...
        if (!force && !hanging.survives()) {//&& !this.getHandle().generation && !hanging.survives()) { // TODO
    ...
    protected void update() {
        ...
        // update redstone
        //if (!this.getHandle().generation) { // TODO
    ...
    public void setItem(org.bukkit.inventory.ItemStack item, boolean playSound) {
       ...
       // this.getHandle().setItem(CraftItemStack.asNMSCopy(item), !this.getHandle().generation, !this.getHandle().generation && playSound); // TODO
    }
