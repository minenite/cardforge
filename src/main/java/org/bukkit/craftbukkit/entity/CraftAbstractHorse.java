...
public abstract class CraftAbstractHorse extends CraftAnimals implements AbstractHorse {
    ...
    public void setMaxDomestication(int value) {
       ...
       ((AbstractHorseBridge)this.getHandle()).cardboard$setMaxDomestication(value);
    }
    ...
    public void setOwner(AnimalTamer owner) {
        if (owner != null) {
            this.setTamed(true);
            ((MobBridge)this.getHandle()).cardboard$setTarget(null, null);
    ...
    public boolean isEating() {
        return ((AbstractHorseBridge)this.getHandle()).cardboard$isMouthOpen();
    }

    @Override
    public void setEating(boolean eating) {
        ((AbstractHorseBridge)this.getHandle()).cardboard$setMouthOpen(eating);
    }
}
