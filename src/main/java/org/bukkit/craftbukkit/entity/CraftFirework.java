...
public class CraftFirework extends CraftProjectile implements Firework {
    ...
    public void setFireworkMeta(FireworkMeta meta) {
        ...
        ((SynchedEntityDataBridge)this.getHandle().getEntityData()).markDirty(FireworkRocketEntity.DATA_ID_FIREWORKS_ITEM);
    }
    ...
    public LivingEntity getAttachedTo() {
        ...
        return (entity != null) ? (LivingEntity) ((org.cardboardpowered.bridge.world.entity.EntityBridge) (Object) entity).getBukkitEntity() : null;
    }
    ...
    public java.util.UUID getSpawningEntity() {
        //return getHandle().spawningEntity; // TODO
        return null;
    }
