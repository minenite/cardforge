...
public class CraftFishHook extends CraftProjectile implements FishHook {
    ...
    public int getMinWaitTime() {
        //return this.getHandle().minWaitTime; // TODO
        return 100;
    }
    ...
    public void setMinWaitTime(int minWaitTime) {
        ...
        //hook.minWaitTime = minWaitTime; // TODO
    }

    @Override
    public int getMaxWaitTime() {
        //return this.getHandle().maxWaitTime; // TODO
        return 600;
    }
    ...
    public void setMaxWaitTime(int maxWaitTime) {
        ...
        FishingHook hook = this.getHandle();
        //hook.maxWaitTime = maxWaitTime; // TODO
    }
    ...
    public void setWaitTime(int min, int max) {
       ...
       // this.getHandle().maxWaitTime = max; // TODO
    }

    @Override
    public int getMinLureTime() {
        //return this.getHandle().minLureTime; // TODO
        return 20;
    }
    ...
    public void setMinLureTime(int minLureTime) {
        ...
        //this.getHandle().minLureTime = minLureTime; // TODO
    }

    @Override
    public int getMaxLureTime() {
        //return this.getHandle().maxLureTime; // TODO
        return 80;
    }
    ...
    public void setMaxLureTime(int maxLureTime) {
       ...
       // this.getHandle().maxLureTime = maxLureTime; // TODO
    }
    ...
    public void setLureTime(int min, int max) {
       ...
       // this.getHandle().maxLureTime = max; // TODO
    }

    @Override
    public float getMinLureAngle() {
        //return this.getHandle().minLureAngle; // TODO
        return 0.0F;
    }
    ...
    public void setMinLureAngle(float minLureAngle) {
        ...
        //this.getHandle().minLureAngle = minLureAngle; // TODO
    }

    @Override
    public float getMaxLureAngle() {
        //return this.getHandle().maxLureAngle; // TODO
        return 360.0F;
    }
    ...
    public void setMaxLureAngle(float maxLureAngle) {
        ...
        //this.getHandle().maxLureAngle = maxLureAngle; // TODO
    }
    ...
    public void setLureAngle(float min, float max) {
       ...
       // this.getHandle().maxLureAngle = max; // TODO
    }

    @Override
    public boolean isSkyInfluenced() {
        //return this.getHandle().skyInfluenced; // TODO
        return true;
    }

    @Override
    public void setSkyInfluenced(boolean skyInfluenced) {
        //this.getHandle().skyInfluenced = skyInfluenced; // TODO
    }

    @Override
    public boolean isRainInfluenced() {
        //return this.getHandle().rainInfluenced; // TODO
        return true;
    }

    @Override
    public void setRainInfluenced(boolean rainInfluenced) {
        //this.getHandle().rainInfluenced = rainInfluenced; // TODO
    }

    @Override
    public boolean getApplyLure() {
        //return this.getHandle().applyLure; // TODO
        return true;
    }

    @Override
    public void setApplyLure(boolean applyLure) {
       // this.getHandle().applyLure = applyLure; // TODO
    }
    ...
    public void setTimeUntilBite(final int ticks) {
        ...
        if (!alreadyInLuringPhase) {
          //  hook.fishAngle = net.minecraft.util.Mth.nextFloat(hook.random, hook.minLureAngle, hook.maxLureAngle); // TODO
    ...
    public int retrieve(EquipmentSlot slot) {
        ...
        return fishingHook.retrieve(itemInHand);//, hand); // TODO
    }
}
