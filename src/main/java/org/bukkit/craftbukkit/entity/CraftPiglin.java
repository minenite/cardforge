...
public class CraftPiglin extends CraftPiglinAbstract implements Piglin, com.destroystokyo.paper.entity.CraftRangedEntity<net.minecraft.world.entity.monster.piglin.Piglin> { // Paper
    ...
    public boolean addBarterMaterial(Material material) {
        ...
        //return this.getHandle().allowedBarterItems.add(item); // TODO
        return false;
    }
    ...
    public boolean removeBarterMaterial(Material material) {
        ...
        Item item = CraftItemType.bukkitToMinecraft(material);
        //return this.getHandle().allowedBarterItems.remove(item); // TODO
        return false;
    }
    ...
    public boolean addMaterialOfInterest(Material material) {
        ...
        Item item = CraftItemType.bukkitToMinecraft(material);
        //return this.getHandle().interestItems.add(item); // TODO
        return false;
    }
    ...
    public boolean removeMaterialOfInterest(Material material) {
        ...
        Item item = CraftItemType.bukkitToMinecraft(material);
        //return this.getHandle().interestItems.remove(item); // TODO
        return false;
    }

    @Override
    public Set<Material> getInterestList() {
        //return Collections.unmodifiableSet(this.getHandle().interestItems.stream().map(CraftItemType::minecraftToBukkit).collect(Collectors.toSet())); // TODO
        return Set.of();
    }

    @Override
    public Set<Material> getBarterList() {
        //return Collections.unmodifiableSet(this.getHandle().allowedBarterItems.stream().map(CraftItemType::minecraftToBukkit).collect(Collectors.toSet())); // TODO
        return Set.of();
    }
