...
public abstract class CraftAbstractWindCharge extends CraftFireball implements AbstractWindCharge {
    ...
    @Override
    public void explode() {
        ((org.minenite.cardforge.mixin.invoker.AbstractWindChargeInvoker) (Object) this.getHandle()).cardforge$explode(this.getHandle().position());
        this.getHandle().discard();//EntityRemoveEvent.Cause.EXPLODE); // SPIGOT-7577 - explode doesn't discard the entity, this happens only in tick and onHitBlock // TODO
    }
}
