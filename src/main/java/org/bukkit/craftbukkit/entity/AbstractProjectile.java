...
public abstract class AbstractProjectile extends CraftEntity implements Projectile {
	...
	public boolean canHitEntity(org.bukkit.entity.Entity entity) {
		//return this.getHandle().canHitEntityPublic(((CraftEntity) entity).getHandle()); // TODO
	...
	public final org.bukkit.projectiles.ProjectileSource getShooter() {
		//this.getHandle().refreshProjectileSource(true); // Paper - Refresh ProjectileSource for projectiles // TODO
		return ((EntityBridge)this.getHandle()).getProjectileSourceBukkit();
    }
	...
	public final void setShooter(org.bukkit.projectiles.ProjectileSource shooter) {
		...
		((EntityBridge)this.getHandle()).setProjectileSourceBukkit(shooter);
	}
