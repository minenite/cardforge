...
public abstract class CraftMinecart extends CraftVehicle implements Minecart {
    ...
    public boolean isSlowWhenEmpty() {
        //return this.getHandle().slowWhenEmpty; // TODO
        return true;
    }

    @Override
    public void setSlowWhenEmpty(boolean slow) {
        //this.getHandle().slowWhenEmpty = slow; // TODO
    }

    @Override
    public Vector getFlyingVelocityMod() {
        //return this.getHandle().getFlyingVelocityMod(); // TODO
        return new org.bukkit.util.Vector(0.95, 0.95, 0.95);
    }

    @Override
    public void setFlyingVelocityMod(Vector flying) {
        //this.getHandle().setFlyingVelocityMod(flying); // TODO
    }

    @Override
    public Vector getDerailedVelocityMod() {
        //return this.getHandle().getDerailedVelocityMod(); // TODO
        return new org.bukkit.util.Vector(0.5, 0.5, 0.5);
    }

    @Override
    public void setDerailedVelocityMod(Vector derailed) {
        //this.getHandle().setDerailedVelocityMod(derailed); // TODO
    }
    ...
    public net.kyori.adventure.util.TriState getFrictionState() {
        //return this.getHandle().frictionState; // TODO
    ...
    public void setFrictionState(@org.jetbrains.annotations.NotNull net.kyori.adventure.util.TriState state) {
        ...
        //this.getHandle().frictionState = state; // TODO
    }
}
