...
public class CraftCreeper extends CraftMonster implements Creeper {
    ...
    public void setPowered(boolean powered) {
        ...
        if (!this.callPowerEvent(cause)) { //if (this.getHandle().generation || !this.callPowerEvent(cause)) { // TODO
            ((CreeperBridge)this.getHandle()).cardboard$setPowered(powered);
        }
    }

    private boolean callPowerEvent(CreeperPowerEvent.PowerCause cause) {
        CreeperPowerEvent event = new CreeperPowerEvent((Creeper) ((EntityBridge)this.getHandle()).getBukkitEntity(), cause);
    ...
    public void ignite(Entity entity) {
        ...
        //this.getHandle().entityIgniter = ((CraftEntity) entity).getHandle(); // TODO
    ...
    public Entity getIgniter() {
        //return (this.getHandle().entityIgniter != null) ? this.getHandle().entityIgniter.getBukkitEntity() : null; // TODO
        return null;
    }
    ...
    public void setIgnited(boolean ignited) {
        //getHandle().setIgnited(ignited); // TODO
    }
