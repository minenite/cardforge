...
public class CraftEnderDragon extends CraftMob implements EnderDragon, CraftEnemy {
    ...
    public org.bukkit.Location getPodium() {
        //return CraftLocation.toBukkit(this.getHandle().getPodium(), this.getWorld()); // TODO
        return null;
    }
    ...
    public void setPodium(org.bukkit.Location location) {
        if (location == null) {
            //this.getHandle().setPodium(null); // TODO
        } else {
            ...
            //this.getHandle().setPodium(CraftLocation.toBlockPosition(location)); // TODO
        }
    }
