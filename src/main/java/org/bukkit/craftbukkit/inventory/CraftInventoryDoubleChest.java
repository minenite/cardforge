...
import org.cardboardpowered.impl.inventory.CardboardChestBlockDoubleInventory;
...
public class CraftInventoryDoubleChest extends CraftInventory implements DoubleChestInventory {
    ...
    public CraftInventoryDoubleChest(CardboardChestBlockDoubleInventory inventory) {
        super(inventory.inventorylargechest);
        this.provider = inventory;
        this.left = new CraftInventory(inventory.inventorylargechest.container1);
        this.right = new CraftInventory(inventory.inventorylargechest.container2);
    }
