...
public class CraftInventoryFurnace extends CraftInventory implements FurnaceInventory {
    ...
    public boolean canSmelt(ItemStack stack) {
        ...
        /*net.minecraft.server.level.ServerLevel world = ((CraftWorld) org.bukkit.Bukkit.getWorlds().get(0)).getHandle();
        return stack != null && !stack.getType().isEmpty() && world.recipeAccess().getRecipeFor((((AbstractFurnaceBlockEntity) this.inventory)), new net.minecraft.world.item.crafting.SingleRecipeInput(CraftItemStack.asNMSCopy(stack)), world).isPresent();*/
        return false; // TODO
    }
    // Paper end
