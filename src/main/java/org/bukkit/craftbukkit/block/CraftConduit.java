...
public class CraftConduit extends CraftBlockEntityState<ConduitBlockEntity> implements Conduit {
    ...
    public int getRange() {
        this.ensureNoWorldGeneration();
        ConduitBlockEntity conduit = (ConduitBlockEntity) this.getBlockEntityFromWorld();
        return (conduit != null) ? ConduitBlockEntityBridge.getRange(conduit.effectBlocks) : 0;
    }
    ...
    public boolean hasTarget() {
        ...
        final net.minecraft.world.entity.LivingEntity destroyTarget = EntityReference.get(conduit.destroyTarget, (Level) this.getWorldHandle(), net.minecraft.world.entity.LivingEntity.class);
