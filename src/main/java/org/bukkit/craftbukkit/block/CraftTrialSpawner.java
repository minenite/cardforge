...
public class CraftTrialSpawner extends CraftBlockEntityState<TrialSpawnerBlockEntity> implements TrialSpawner {
    ...
    public void setCooldownLength(int ticks) {
        this.getSnapshot().trialSpawner.config = ((TrialSpawner_FullConfigBridge)(Object)this.getSnapshot().trialSpawner.config).cardboard$overrideTargetCooldownLength(ticks);
    }
    ...
    public void setRequiredPlayerRange(int requiredPlayerRange) {
        this.getSnapshot().trialSpawner.config = ((TrialSpawner_FullConfigBridge)(Object)this.getSnapshot().trialSpawner.config).cardboard$overrideRequiredPlayerRange(requiredPlayerRange);
    }
    ...
    protected void applyTo(TrialSpawnerBlockEntity blockEntity) {
        ...
        blockEntity.trialSpawner.config = ((TrialSpawner_FullConfigBridge)(Object)blockEntity.trialSpawner.config).cardboard$overrideConfigs(
