...
public class CraftTrialSpawnerConfiguration implements TrialSpawnerConfiguration {
    ...
    public EntityType getSpawnedType() {
        ...
        try (final ProblemReporter.ScopedCollector problemReporter = new ProblemReporter.ScopedCollector(
            ...
            Optional<net.minecraft.world.entity.EntityType<?>> type = net.minecraft.world.entity.EntityType.by(
                TagValueInputBridge.createGlobal(
                    problemReporter,
    ...
    public void setRequiredPlayerRange(int requiredPlayerRange) {
        this.snapshot.trialSpawner.config = ((TrialSpawner_FullConfigBridge)(Object)this.snapshot.trialSpawner.config).cardboard$overrideRequiredPlayerRange(requiredPlayerRange);
    }
