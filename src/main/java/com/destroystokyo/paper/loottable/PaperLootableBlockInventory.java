...
public interface PaperLootableBlockInventory extends LootableBlockInventory, PaperLootableInventory, PaperLootableBlock {
    ...
    default PaperLootableInventoryData lootableDataForAPI() {
        //return Objects.requireNonNull(this.getRandomizableContainer().lootableData(), "Can only manage loot tables on tile entities with lootableData"); // TODO
        return new PaperLootableInventoryData();
    }
