    ...
    record Craft<M, A extends Keyed>(
        ...
        public Craft {
        	...
        	if (pac.startsWith("net.minecraft")) {
        		// Huh
        		System.out.println("ignoring preload of " + classToPreload);
        	}
        	
            // Preconditions.checkArgument(!pac.startsWith("net.minecraft"), classToPreload + " should not be in the net.minecraft package as the class-to-preload");
        }
    }
