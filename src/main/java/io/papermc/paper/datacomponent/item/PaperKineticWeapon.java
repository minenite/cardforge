...
public record PaperKineticWeapon(
    ...
    private static net.minecraft.world.item.component.KineticWeapon.Condition toNms(final Condition api) {
    ...
    ) implements Condition, Handleable<net.minecraft.world.item.component.KineticWeapon.Condition> {
    ...
    static final class BuilderImpl implements Builder {
        ...
        @Override
        public Builder contactCooldownTicks(final int ticks) {
        ...
        @Override
        public Builder delayTicks(final int ticks) {
        ...
        @Override
        public Builder dismountConditions(final @Nullable Condition condition) {
            this.dismountConditions = condition == null ? null : toNms(condition);
            return this;
        }

        @Override
        public Builder knockbackConditions(final @Nullable Condition condition) {
            this.knockbackConditions = condition == null ? null : toNms(condition);
            return this;
        }

        @Override
        public Builder damageConditions(final @Nullable Condition condition) {
