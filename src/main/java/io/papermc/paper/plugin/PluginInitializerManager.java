...
public class PluginInitializerManager {
    ...
    private static final Logger LOGGER = CardboardLogger.getSLF4J("PaperPluginManager");
    ...
    private static PluginInitializerManager parse(@NotNull final OptionSet minecraftOptionSet) throws Exception {
        ...
        final String updateDirectoryName = "update";// configuration.getString("settings.update-folder", "update");
    ...
    public static void reload(DedicatedServer dedicatedServer) {
        ...
        */
    	...
    	LOGGER.error("Paper Plugin reloading is not implemented on Cardboard");
    }
}
