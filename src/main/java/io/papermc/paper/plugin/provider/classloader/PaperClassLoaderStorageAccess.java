...
class PaperClassLoaderStorageAccess {
     ...
     * by the server.
     */
    static final PaperClassLoaderStorage INSTANCE = new io.papermc.paper.plugin.entrypoint.classloader.group.PaperPluginClassLoaderStorage
(); // Services.service(PaperClassLoaderStorage.class).orElseThrow();
