...
public final class ServerboundPacketClassSerializer extends ScalarSerializer<Class<? extends Packet<?>>> {
    ...
    private static final Logger LOGGER = CardboardLogger.getSLF4J("PaperConfiguration");
    ...
    static {
        try {
            ...
            Preconditions.checkState(ID_TO_INFO.size() == 78, "Packet class map must have 78 entries");
